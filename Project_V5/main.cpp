...
int main(int argc, char** argv) {
    ...
    cout<<"This game of blackjack will choose from this set of numbers."<<endl;
    for(int cards=1;cards<=11;cards++){     //Displays cards that are in play.
        cout<<cards<<setw(3);
    }
    cout<<endl;
    ...
    if(plyrH>21){                                 //If players original hand is
        ...
        if(pBet=='a'){
            if(plyrH > 21 && dlrH > 21 || plyrH == dlrH){
                ...
                plyrH>dlrH && plyrH<=21 || dlrH>21 ? cout<<"You win $"<<y1 :
                    cout<<"You lose $"<<y1;
                }
            }
            else if(pBet=='b'){
                ...
                plyrH>dlrH && plyrH<=21 || dlrH>21 ? cout<<"You win $"<<y2 :
                    cout<<"You lose $"<<y2;
                }
            }
            else if(pBet=='c'){
                if(plyrH > 21 && dlrH > 21 || plyrH == dlrH){
                    ...
                    plyrH>dlrH && plyrH<=21 || dlrH>21 ? cout<<"You win $"<<y3 :
                        cout<<"You lose $"<<y3;
                }
            }
        return 0;
        ...
        if(plyrCh==1 || plyrCh==2){
            switch(plyrCh){
                ...
                case 2://If the player doesn't bust with their original hand or
                       ...
                       cout<<setw(10)<<static_cast<int>(dlrH)<<endl;
                       //If the players hand is greater than dealers original
                       //hand it will continue to hit until it beats the
                       //players hand or it bust.
                ...
                //Displays money return for a bet at $1.00 where no one wins.
                if(pBet=='a'){
                    if(plyrH > 21 && dlrH > 21 || plyrH == dlrH){
                        cout<<"You keep your $1.00"<<endl;
                    }
                ...
                //Displays money return for a bet at $2.50 where no one wins.
                else if(pBet=='b'){
                    if(plyrH > 21 && dlrH > 21 || plyrH == dlrH){
                        cout<<"You keep your $2.50"<<endl;
                    }
                ...
                //Displays money return for a bet at $5.00 where no one wins.       
                else if(pBet=='c'){
                    if(plyrH > 21 && dlrH > 21 || plyrH == dlrH){
                        cout<<"You keep your $5.00"<<endl;
                    }
    ...
    //Code from 244 through 270 runs same as code from 163 through 197.
    if(pBet=='a'){
        if(plyrH > 21 && dlrH > 21 || plyrH == dlrH){
            cout<<"You keep your $1.00"<<endl;
        }       
