...
//Declare Variables
    ...
    for(int cards=1;cards<=11;cards++){
        cout<<cards<<setw(3);
    }
    cout<<endl;
    cout<<"Enter a for a $1.00 bet."<<endl;
    cout<<"Enter b for a $2.50 bet."<<endl;
    cout<<"Enter c for a $5.00 bet."<<endl;
    ...
    cout<<setw(10)<<static_cast<int>(dlrC1)<<endl; //Displays dealers first card.
    cout<<"---------------------"<<endl;
    cout<<setw(14)<<"Your Hand"<<endl;
    cout<<setw(8)<<static_cast<int>(plyrC1); //Displays players first card.
    cout<<setw(4)<<static_cast<int>(plyrC2)<<endl;//Displays players second card.
